...
namespace OpenGL
{
    public partial class Form1 : Form
    {
        ...
        private bool InitShaders()
        {
            ...
            loadShader(vertexShaderText, ShaderType.VertexShader, BasicProgramID, out BasicVertexShader);
            loadShader(fragmentShaderText, ShaderType.FragmentShader, BasicProgramID, out BasicFragmentShader);
        ...
        Material[] fillMaterials()
        {
            ...
            materials[6] = new Material(new Vector3(0, 1, 1), new Vector4(0.4f, 0.9f, 0.9f, 50.0f), 0.8f, 1.5f, MIRROR_REFLECTION);
            return materials;
        }
